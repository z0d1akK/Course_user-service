...
@AllArgsConstructor
@Builder
@Schema(description = "DTO for updating payment card")
public class UpdatePaymentCardRequestDto {
    ...
    @Schema(description = "Card holder full name", example = "updatedName updatedSurname")
    @Size(min = 1, max = 255, message = ValidationMessages.CARD_HOLDER_SIZE)
    private String holder;

    @Schema(description = "Card expiration date in MM/YY format", example = "11/11")
